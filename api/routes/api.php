...
return [
    'GET' => [
        ...
        '/classrooms/show' => ['/app/controllers/ClassroomController.php', 'ClassroomController', 'show'],
    ...
    'POST' => [
        ...
        '/classrooms/update' => ['/app/controllers/ClassroomController.php', 'ClassroomController', 'update'],
